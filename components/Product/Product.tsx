    ...
    return (
        <div className={className} {...props}>
            <Card className={styles.product}>
                ...
                <div className={styles.rating}><Rating rating={product.reviewsAvg ?? product.initialRating} /></div>
                ...
                <div className={styles.rateTitle}><a href="#more-review" onClick={scrollToReview}>{product.reviewCount} {decOfNum(product.reviewCount, ['отзыв', 'отзыва', 'отзывов'])}</a></div>
